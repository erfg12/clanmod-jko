...
;91:	//this will prevent that from happening:
...
line 123
;123:	syscall( G_TRACE, results, start, mins, maxs, end, passEntityNum, contentmask, 0, 10 );
CNSTI4 24
ARGI4
ADDRFP4 0
INDIRP4
...
line 155
;154:
;155:int trap_EntitiesInBox( const vec3_t mins, const vec3_t maxs, int *list, int maxcount ) {
line 156
;156:	return syscall( G_ENTITIES_IN_BOX, mins, maxs, list, maxcount );
CNSTI4 32
ARGI4
ADDRFP4 0
INDIRP4
...
;157:}
;158:
;159:qboolean trap_EntityContact( const vec3_t mins, const vec3_t maxs, const gentity_t *ent ) {
line 160
;160:	return syscall( G_ENTITY_CONTACT, mins, maxs, ent );
CNSTI4 33
ARGI4
ADDRFP4 0
INDIRP4
...
;161:}
;162:
;163:int trap_BotAllocateClient( void ) {
line 164
;164:	return syscall( G_BOT_ALLOCATE_CLIENT );
CNSTI4 34
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;165:}
;166:
;167:void trap_BotFreeClient( int clientNum ) {
line 168
;168:	syscall( G_BOT_FREE_CLIENT, clientNum );
CNSTI4 35
ARGI4
ADDRFP4 0
INDIRI4
...
line 171
;170:
;171:void trap_GetUsercmd( int clientNum, usercmd_t *cmd ) {
line 172
;172:	syscall( G_GET_USERCMD, clientNum, cmd );
CNSTI4 36
ARGI4
ADDRFP4 0
INDIRI4
...
line 175
;174:
;175:qboolean trap_GetEntityToken( char *buffer, int bufferSize ) {
line 176
;176:	return syscall( G_GET_ENTITY_TOKEN, buffer, bufferSize );
CNSTI4 37
ARGI4
ADDRFP4 0
INDIRP4
...
;177:}
;178:
;179:int trap_FS_GetFileList(  const char *path, const char *extension, char *listbuf, int bufsize ) {
line 180
;180:	return syscall( G_FS_GETFILELIST, path, extension, listbuf, bufsize );
CNSTI4 38
ARGI4
ADDRFP4 0
INDIRP4
...
;181:}
;182:
;183:int trap_DebugPolygonCreate(int color, int numPoints, vec3_t *points) {
line 184
;184:	return syscall( G_DEBUG_POLYGON_CREATE, color, numPoints, points );
CNSTI4 39
ARGI4
ADDRFP4 0
INDIRI4
...
;185:}
;186:
;187:void trap_DebugPolygonDelete(int id) {
line 188
;188:	syscall( G_DEBUG_POLYGON_DELETE, id );
CNSTI4 40
ARGI4
ADDRFP4 0
INDIRI4
...
line 191
;190:
;191:int trap_RealTime( qtime_t *qtime ) {
line 192
;192:	return syscall( G_REAL_TIME, qtime );
CNSTI4 41
ARGI4
ADDRFP4 0
INDIRP4
...
;193:}
;194:
;195:void trap_SnapVector( float *v ) {
line 196
;196:	syscall( G_SNAPVECTOR, v );
CNSTI4 42
ARGI4
ADDRFP4 0
INDIRP4
...
line 199
;198:
;199:void trap_TraceCapsule( trace_t *results, const vec3_t start, const vec3_t mins, const vec3_t maxs, const vec3_t end, int passEntityNum, int contentmask ) {
line 200
;200:	syscall( G_TRACECAPSULE, results, start, mins, maxs, end, passEntityNum, contentmask, 0, 10 );
CNSTI4 43
ARGI4
ADDRFP4 0
INDIRP4
...
line 203
;202:
;203:qboolean trap_EntityContactCapsule( const vec3_t mins, const vec3_t maxs, const gentity_t *ent ) {
line 204
;204:	return syscall( G_ENTITY_CONTACTCAPSULE, mins, maxs, ent );
CNSTI4 44
ARGI4
ADDRFP4 0
INDIRP4
...
;205:}
;206:
;207:qboolean trap_SP_RegisterServer( const char *package ) 
;208:{
line 209
;209:	return syscall( SP_REGISTER_SERVER_CMD, package );
CNSTI4 45
ARGI4
ADDRFP4 0
INDIRP4
...
;210:}
;211:
;212:int trap_SP_GetStringTextString(const char *text, char *buffer, int bufferLength)
;213:{
line 214
;214:	return syscall( SP_GETSTRINGTEXTSTRING, text, buffer, bufferLength );
CNSTI4 46
ARGI4
ADDRFP4 0
INDIRP4
...
;215:}
;216:
;217:qboolean trap_ROFF_Clean( void ) 
;218:{
line 219
;219:	return syscall( G_ROFF_CLEAN );
CNSTI4 47
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;220:}
;221:
;222:void trap_ROFF_UpdateEntities( void ) 
;223:{
line 224
;224:	syscall( G_ROFF_UPDATE_ENTITIES );
CNSTI4 48
ARGI4
ADDRGP4 syscall
INDIRP4
...
line 228
;226:
;227:int trap_ROFF_Cache( char *file ) 
;228:{
line 229
;229:	return syscall( G_ROFF_CACHE, file );
CNSTI4 49
ARGI4
ADDRFP4 0
INDIRP4
...
;230:}
;231:
;232:qboolean trap_ROFF_Play( int entID, int roffID, qboolean doTranslation ) 
;233:{
line 234
;234:	return syscall( G_ROFF_PLAY, entID, roffID, doTranslation );
CNSTI4 50
ARGI4
ADDRFP4 0
INDIRI4
...
;235:}
;236:
;237:qboolean trap_ROFF_Purge_Ent( int entID ) 
;238:{
line 239
;239:	return syscall( G_ROFF_PURGE_ENT, entID );
CNSTI4 51
ARGI4
ADDRFP4 0
INDIRI4
...
;240:}
;241:
;242:// BotLib traps start here
;243:int trap_BotLibSetup( void ) {
line 244
;244:	return syscall( BOTLIB_SETUP );
CNSTI4 200
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;245:}
;246:
;247:int trap_BotLibShutdown( void ) {
line 248
;248:	return syscall( BOTLIB_SHUTDOWN );
CNSTI4 201
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;249:}
;250:
;251:int trap_BotLibVarSet(char *var_name, char *value) {
line 252
;252:	return syscall( BOTLIB_LIBVAR_SET, var_name, value );
CNSTI4 202
ARGI4
ADDRFP4 0
INDIRP4
...
;253:}
;254:
;255:int trap_BotLibVarGet(char *var_name, char *value, int size) {
line 256
;256:	return syscall( BOTLIB_LIBVAR_GET, var_name, value, size );
CNSTI4 203
ARGI4
ADDRFP4 0
INDIRP4
...
;257:}
;258:
;259:int trap_BotLibDefine(char *string) {
line 260
;260:	return syscall( BOTLIB_PC_ADD_GLOBAL_DEFINE, string );
CNSTI4 204
ARGI4
ADDRFP4 0
INDIRP4
...
;261:}
;262:
;263:int trap_BotLibStartFrame(float time) {
line 264
;264:	return syscall( BOTLIB_START_FRAME, PASSFLOAT( time ) );
ADDRFP4 0
INDIRF4
ARGF4
ADDRLP4 0
...
;265:}
;266:
;267:int trap_BotLibLoadMap(const char *mapname) {
line 268
;268:	return syscall( BOTLIB_LOAD_MAP, mapname );
CNSTI4 206
ARGI4
ADDRFP4 0
INDIRP4
...
;269:}
;270:
;271:int trap_BotLibUpdateEntity(int ent, void /* struct bot_updateentity_s */ *bue) {
line 272
;272:	return syscall( BOTLIB_UPDATENTITY, ent, bue );
CNSTI4 207
ARGI4
ADDRFP4 0
INDIRI4
...
;273:}
;274:
;275:int trap_BotLibTest(int parm0, char *parm1, vec3_t parm2, vec3_t parm3) {
line 276
;276:	return syscall( BOTLIB_TEST, parm0, parm1, parm2, parm3 );
CNSTI4 208
ARGI4
ADDRFP4 0
INDIRI4
...
;277:}
;278:
;279:int trap_BotGetSnapshotEntity( int clientNum, int sequence ) {
line 280
;280:	return syscall( BOTLIB_GET_SNAPSHOT_ENTITY, clientNum, sequence );
CNSTI4 209
ARGI4
ADDRFP4 0
INDIRI4
...
;281:}
;282:
;283:int trap_BotGetServerCommand(int clientNum, char *message, int size) {
line 284
;284:	return syscall( BOTLIB_GET_CONSOLE_MESSAGE, clientNum, message, size );
CNSTI4 210
ARGI4
ADDRFP4 0
INDIRI4
...
;285:}
;286:
;287:void trap_BotUserCommand(int clientNum, usercmd_t *ucmd) {
line 288
;288:	syscall( BOTLIB_USER_COMMAND, clientNum, ucmd );
CNSTI4 211
ARGI4
ADDRFP4 0
INDIRI4
...
line 291
;290:
;291:void trap_AAS_EntityInfo(int entnum, void /* struct aas_entityinfo_s */ *info) {
line 292
;292:	syscall( BOTLIB_AAS_ENTITY_INFO, entnum, info );
CNSTI4 303
ARGI4
ADDRFP4 0
INDIRI4
...
line 295
;294:
;295:int trap_AAS_Initialized(void) {
line 296
;296:	return syscall( BOTLIB_AAS_INITIALIZED );
CNSTI4 304
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;297:}
;298:
;299:void trap_AAS_PresenceTypeBoundingBox(int presencetype, vec3_t mins, vec3_t maxs) {
line 300
;300:	syscall( BOTLIB_AAS_PRESENCE_TYPE_BOUNDING_BOX, presencetype, mins, maxs );
CNSTI4 305
ARGI4
ADDRFP4 0
INDIRI4
...
line 303
;302:
;303:float trap_AAS_Time(void) {
line 305
;304:	int temp;
;305:	temp = syscall( BOTLIB_AAS_TIME );
CNSTI4 306
ARGI4
ADDRLP4 4
ADDRGP4 syscall
...
;307:}
;308:
;309:int trap_AAS_PointAreaNum(vec3_t point) {
line 310
;310:	return syscall( BOTLIB_AAS_POINT_AREA_NUM, point );
CNSTI4 307
ARGI4
ADDRFP4 0
INDIRP4
...
;311:}
;312:
;313:int trap_AAS_PointReachabilityAreaIndex(vec3_t point) {
line 314
;314:	return syscall( BOTLIB_AAS_POINT_REACHABILITY_AREA_INDEX, point );
CNSTI4 577
ARGI4
ADDRFP4 0
INDIRP4
...
;315:}
;316:
;317:int trap_AAS_TraceAreas(vec3_t start, vec3_t end, int *areas, vec3_t *points, int maxareas) {
line 318
;318:	return syscall( BOTLIB_AAS_TRACE_AREAS, start, end, areas, points, maxareas );
CNSTI4 308
ARGI4
ADDRFP4 0
INDIRP4
...
;319:}
;320:
;321:int trap_AAS_BBoxAreas(vec3_t absmins, vec3_t absmaxs, int *areas, int maxareas) {
line 322
;322:	return syscall( BOTLIB_AAS_BBOX_AREAS, absmins, absmaxs, areas, maxareas );
CNSTI4 301
ARGI4
ADDRFP4 0
INDIRP4
...
;323:}
;324:
;325:int trap_AAS_AreaInfo( int areanum, void /* struct aas_areainfo_s */ *info ) {
line 326
;326:	return syscall( BOTLIB_AAS_AREA_INFO, areanum, info );
CNSTI4 302
ARGI4
ADDRFP4 0
INDIRI4
...
;327:}
;328:
;329:int trap_AAS_PointContents(vec3_t point) {
line 330
;330:	return syscall( BOTLIB_AAS_POINT_CONTENTS, point );
CNSTI4 309
ARGI4
ADDRFP4 0
INDIRP4
...
;331:}
;332:
;333:int trap_AAS_NextBSPEntity(int ent) {
line 334
;334:	return syscall( BOTLIB_AAS_NEXT_BSP_ENTITY, ent );
CNSTI4 310
ARGI4
ADDRFP4 0
INDIRI4
...
;335:}
;336:
;337:int trap_AAS_ValueForBSPEpairKey(int ent, char *key, char *value, int size) {
line 338
;338:	return syscall( BOTLIB_AAS_VALUE_FOR_BSP_EPAIR_KEY, ent, key, value, size );
CNSTI4 311
ARGI4
ADDRFP4 0
INDIRI4
...
;339:}
;340:
;341:int trap_AAS_VectorForBSPEpairKey(int ent, char *key, vec3_t v) {
line 342
;342:	return syscall( BOTLIB_AAS_VECTOR_FOR_BSP_EPAIR_KEY, ent, key, v );
CNSTI4 312
ARGI4
ADDRFP4 0
INDIRI4
...
;343:}
;344:
;345:int trap_AAS_FloatForBSPEpairKey(int ent, char *key, float *value) {
line 346
;346:	return syscall( BOTLIB_AAS_FLOAT_FOR_BSP_EPAIR_KEY, ent, key, value );
CNSTI4 313
ARGI4
ADDRFP4 0
INDIRI4
...
;347:}
;348:
;349:int trap_AAS_IntForBSPEpairKey(int ent, char *key, int *value) {
line 350
;350:	return syscall( BOTLIB_AAS_INT_FOR_BSP_EPAIR_KEY, ent, key, value );
CNSTI4 314
ARGI4
ADDRFP4 0
INDIRI4
...
;351:}
;352:
;353:int trap_AAS_AreaReachability(int areanum) {
line 354
;354:	return syscall( BOTLIB_AAS_AREA_REACHABILITY, areanum );
CNSTI4 315
ARGI4
ADDRFP4 0
INDIRI4
...
;355:}
;356:
;357:int trap_AAS_AreaTravelTimeToGoalArea(int areanum, vec3_t origin, int goalareanum, int travelflags) {
line 358
;358:	return syscall( BOTLIB_AAS_AREA_TRAVEL_TIME_TO_GOAL_AREA, areanum, origin, goalareanum, travelflags );
CNSTI4 316
ARGI4
ADDRFP4 0
INDIRI4
...
;359:}
;360:
;361:int trap_AAS_EnableRoutingArea( int areanum, int enable ) {
line 362
;362:	return syscall( BOTLIB_AAS_ENABLE_ROUTING_AREA, areanum, enable );
CNSTI4 300
ARGI4
ADDRFP4 0
INDIRI4
...
;363:}
;364:
;365:int trap_AAS_PredictRoute(void /*struct aas_predictroute_s*/ *route, int areanum, vec3_t origin,
;366:							int goalareanum, int travelflags, int maxareas, int maxtime,
;367:							int stopevent, int stopcontents, int stoptfl, int stopareanum) {
line 368
;368:	return syscall( BOTLIB_AAS_PREDICT_ROUTE, route, areanum, origin, goalareanum, travelflags, maxareas, maxtime, stopevent, stopcontents, stoptfl, stopareanum );
CNSTI4 576
ARGI4
ADDRFP4 0
INDIRP4
...
;369:}
;370:
;371:int trap_AAS_AlternativeRouteGoals(vec3_t start, int startareanum, vec3_t goal, int goalareanum, int travelflags,
;372:										void /*struct aas_altroutegoal_s*/ *altroutegoals, int maxaltroutegoals,
;373:										int type) {
line 374
;374:	return syscall( BOTLIB_AAS_ALTERNATIVE_ROUTE_GOAL, start, startareanum, goal, goalareanum, travelflags, altroutegoals, maxaltroutegoals, type );
CNSTI4 575
ARGI4
ADDRFP4 0
INDIRP4
...
;375:}
;376:
;377:int trap_AAS_Swimming(vec3_t origin) {
line 378
;378:	return syscall( BOTLIB_AAS_SWIMMING, origin );
CNSTI4 317
ARGI4
ADDRFP4 0
INDIRP4
...
;379:}
;380:
;381:int trap_AAS_PredictClientMovement(void /* struct aas_clientmove_s */ *move, int entnum, vec3_t origin, int presencetype, int onground, vec3_t velocity, vec3_t cmdmove, int cmdframes, int maxframes, float frametime, int stopevent, int stopareanum, int visualize) {
line 382
;382:	return syscall( BOTLIB_AAS_PREDICT_CLIENT_MOVEMENT, move, entnum, origin, presencetype, onground, velocity, cmdmove, cmdframes, maxframes, PASSFLOAT(frametime), stopevent, stopareanum, visualize );
ADDRFP4 36
INDIRF4
ARGF4
ADDRLP4 0
...
;383:}
;384:
;385:void trap_EA_Say(int client, char *str) {
line 386
;386:	syscall( BOTLIB_EA_SAY, client, str );
CNSTI4 400
ARGI4
ADDRFP4 0
INDIRI4
...
line 389
;388:
;389:void trap_EA_SayTeam(int client, char *str) {
line 390
;390:	syscall( BOTLIB_EA_SAY_TEAM, client, str );
CNSTI4 401
ARGI4
ADDRFP4 0
INDIRI4
...
line 393
;392:
;393:void trap_EA_Command(int client, char *command) {
line 394
;394:	syscall( BOTLIB_EA_COMMAND, client, command );
CNSTI4 402
ARGI4
ADDRFP4 0
INDIRI4
...
line 397
;396:
;397:void trap_EA_Action(int client, int action) {
line 398
;398:	syscall( BOTLIB_EA_ACTION, client, action );
CNSTI4 403
ARGI4
ADDRFP4 0
INDIRI4
...
line 401
;400:
;401:void trap_EA_Gesture(int client) {
line 402
;402:	syscall( BOTLIB_EA_GESTURE, client );
CNSTI4 404
ARGI4
ADDRFP4 0
INDIRI4
...
line 405
;404:
;405:void trap_EA_Talk(int client) {
line 406
;406:	syscall( BOTLIB_EA_TALK, client );
CNSTI4 405
ARGI4
ADDRFP4 0
INDIRI4
...
line 409
;408:
;409:void trap_EA_Attack(int client) {
line 410
;410:	syscall( BOTLIB_EA_ATTACK, client );
CNSTI4 406
ARGI4
ADDRFP4 0
INDIRI4
...
line 413
;412:
;413:void trap_EA_Alt_Attack(int client) {
line 414
;414:	syscall( BOTLIB_EA_ALT_ATTACK, client );
CNSTI4 407
ARGI4
ADDRFP4 0
INDIRI4
...
line 417
;416:
;417:void trap_EA_ForcePower(int client) {
line 418
;418:	syscall( BOTLIB_EA_FORCEPOWER, client );
CNSTI4 408
ARGI4
ADDRFP4 0
INDIRI4
...
line 421
;420:
;421:void trap_EA_Use(int client) {
line 422
;422:	syscall( BOTLIB_EA_USE, client );
CNSTI4 409
ARGI4
ADDRFP4 0
INDIRI4
...
line 425
;424:
;425:void trap_EA_Respawn(int client) {
line 426
;426:	syscall( BOTLIB_EA_RESPAWN, client );
CNSTI4 410
ARGI4
ADDRFP4 0
INDIRI4
...
line 429
;428:
;429:void trap_EA_Crouch(int client) {
line 430
;430:	syscall( BOTLIB_EA_CROUCH, client );
CNSTI4 411
ARGI4
ADDRFP4 0
INDIRI4
...
line 433
;432:
;433:void trap_EA_MoveUp(int client) {
line 434
;434:	syscall( BOTLIB_EA_MOVE_UP, client );
CNSTI4 412
ARGI4
ADDRFP4 0
INDIRI4
...
line 437
;436:
;437:void trap_EA_MoveDown(int client) {
line 438
;438:	syscall( BOTLIB_EA_MOVE_DOWN, client );
CNSTI4 413
ARGI4
ADDRFP4 0
INDIRI4
...
line 441
;440:
;441:void trap_EA_MoveForward(int client) {
line 442
;442:	syscall( BOTLIB_EA_MOVE_FORWARD, client );
CNSTI4 414
ARGI4
ADDRFP4 0
INDIRI4
...
line 445
;444:
;445:void trap_EA_MoveBack(int client) {
line 446
;446:	syscall( BOTLIB_EA_MOVE_BACK, client );
CNSTI4 415
ARGI4
ADDRFP4 0
INDIRI4
...
line 449
;448:
;449:void trap_EA_MoveLeft(int client) {
line 450
;450:	syscall( BOTLIB_EA_MOVE_LEFT, client );
CNSTI4 416
ARGI4
ADDRFP4 0
INDIRI4
...
line 453
;452:
;453:void trap_EA_MoveRight(int client) {
line 454
;454:	syscall( BOTLIB_EA_MOVE_RIGHT, client );
CNSTI4 417
ARGI4
ADDRFP4 0
INDIRI4
...
line 457
;456:
;457:void trap_EA_SelectWeapon(int client, int weapon) {
line 458
;458:	syscall( BOTLIB_EA_SELECT_WEAPON, client, weapon );
CNSTI4 418
ARGI4
ADDRFP4 0
INDIRI4
...
line 461
;460:
;461:void trap_EA_Jump(int client) {
line 462
;462:	syscall( BOTLIB_EA_JUMP, client );
CNSTI4 419
ARGI4
ADDRFP4 0
INDIRI4
...
line 465
;464:
;465:void trap_EA_DelayedJump(int client) {
line 466
;466:	syscall( BOTLIB_EA_DELAYED_JUMP, client );
CNSTI4 420
ARGI4
ADDRFP4 0
INDIRI4
...
line 469
;468:
;469:void trap_EA_Move(int client, vec3_t dir, float speed) {
line 470
;470:	syscall( BOTLIB_EA_MOVE, client, dir, PASSFLOAT(speed) );
ADDRFP4 8
INDIRF4
ARGF4
ADDRLP4 0
...
line 473
;472:
;473:void trap_EA_View(int client, vec3_t viewangles) {
line 474
;474:	syscall( BOTLIB_EA_VIEW, client, viewangles );
CNSTI4 422
ARGI4
ADDRFP4 0
INDIRI4
...
line 477
;476:
;477:void trap_EA_EndRegular(int client, float thinktime) {
line 478
;478:	syscall( BOTLIB_EA_END_REGULAR, client, PASSFLOAT(thinktime) );
ADDRFP4 4
INDIRF4
ARGF4
ADDRLP4 0
...
line 481
;480:
;481:void trap_EA_GetInput(int client, float thinktime, void /* struct bot_input_s */ *input) {
line 482
;482:	syscall( BOTLIB_EA_GET_INPUT, client, PASSFLOAT(thinktime), input );
ADDRFP4 4
INDIRF4
ARGF4
ADDRLP4 0
...
line 485
;484:
;485:void trap_EA_ResetInput(int client) {
line 486
;486:	syscall( BOTLIB_EA_RESET_INPUT, client );
CNSTI4 425
ARGI4
ADDRFP4 0
INDIRI4
...
line 489
;488:
;489:int trap_BotLoadCharacter(char *charfile, float skill) {
line 490
;490:	return syscall( BOTLIB_AI_LOAD_CHARACTER, charfile, PASSFLOAT(skill));
ADDRFP4 4
INDIRF4
ARGF4
ADDRLP4 0
...
;491:}
;492:
;493:void trap_BotFreeCharacter(int character) {
line 494
;494:	syscall( BOTLIB_AI_FREE_CHARACTER, character );
CNSTI4 501
ARGI4
ADDRFP4 0
INDIRI4
...
line 497
;496:
;497:float trap_Characteristic_Float(int character, int index) {
line 499
;498:	int temp;
;499:	temp = syscall( BOTLIB_AI_CHARACTERISTIC_FLOAT, character, index );
CNSTI4 502
ARGI4
ADDRFP4 0
INDIRI4
...
;501:}
;502:
;503:float trap_Characteristic_BFloat(int character, int index, float min, float max) {
line 505
;504:	int temp;
;505:	temp = syscall( BOTLIB_AI_CHARACTERISTIC_BFLOAT, character, index, PASSFLOAT(min), PASSFLOAT(max) );
ADDRFP4 8
INDIRF4
ARGF4
ADDRLP4 4
...
;507:}
;508:
;509:int trap_Characteristic_Integer(int character, int index) {
line 510
;510:	return syscall( BOTLIB_AI_CHARACTERISTIC_INTEGER, character, index );
CNSTI4 504
ARGI4
ADDRFP4 0
INDIRI4
...
;511:}
;512:
;513:int trap_Characteristic_BInteger(int character, int index, int min, int max) {
line 514
;514:	return syscall( BOTLIB_AI_CHARACTERISTIC_BINTEGER, character, index, min, max );
CNSTI4 505
ARGI4
ADDRFP4 0
INDIRI4
...
;515:}
;516:
;517:void trap_Characteristic_String(int character, int index, char *buf, int size) {
line 518
;518:	syscall( BOTLIB_AI_CHARACTERISTIC_STRING, character, index, buf, size );
CNSTI4 506
ARGI4
ADDRFP4 0
INDIRI4
...
line 521
;520:
;521:int trap_BotAllocChatState(void) {
line 522
;522:	return syscall( BOTLIB_AI_ALLOC_CHAT_STATE );
CNSTI4 507
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;523:}
;524:
;525:void trap_BotFreeChatState(int handle) {
line 526
;526:	syscall( BOTLIB_AI_FREE_CHAT_STATE, handle );
CNSTI4 508
ARGI4
ADDRFP4 0
INDIRI4
...
line 529
;528:
;529:void trap_BotQueueConsoleMessage(int chatstate, int type, char *message) {
line 530
;530:	syscall( BOTLIB_AI_QUEUE_CONSOLE_MESSAGE, chatstate, type, message );
CNSTI4 509
ARGI4
ADDRFP4 0
INDIRI4
...
line 533
;532:
;533:void trap_BotRemoveConsoleMessage(int chatstate, int handle) {
line 534
;534:	syscall( BOTLIB_AI_REMOVE_CONSOLE_MESSAGE, chatstate, handle );
CNSTI4 510
ARGI4
ADDRFP4 0
INDIRI4
...
line 537
;536:
;537:int trap_BotNextConsoleMessage(int chatstate, void /* struct bot_consolemessage_s */ *cm) {
line 538
;538:	return syscall( BOTLIB_AI_NEXT_CONSOLE_MESSAGE, chatstate, cm );
CNSTI4 511
ARGI4
ADDRFP4 0
INDIRI4
...
;539:}
;540:
;541:int trap_BotNumConsoleMessages(int chatstate) {
line 542
;542:	return syscall( BOTLIB_AI_NUM_CONSOLE_MESSAGE, chatstate );
CNSTI4 512
ARGI4
ADDRFP4 0
INDIRI4
...
;543:}
;544:
;545:void trap_BotInitialChat(int chatstate, char *type, int mcontext, char *var0, char *var1, char *var2, char *var3, char *var4, char *var5, char *var6, char *var7 ) {
line 546
;546:	syscall( BOTLIB_AI_INITIAL_CHAT, chatstate, type, mcontext, var0, var1, var2, var3, var4, var5, var6, var7 );
CNSTI4 513
ARGI4
ADDRFP4 0
INDIRI4
...
line 549
;548:
;549:int	trap_BotNumInitialChats(int chatstate, char *type) {
line 550
;550:	return syscall( BOTLIB_AI_NUM_INITIAL_CHATS, chatstate, type );
CNSTI4 569
ARGI4
ADDRFP4 0
INDIRI4
...
;551:}
;552:
;553:int trap_BotReplyChat(int chatstate, char *message, int mcontext, int vcontext, char *var0, char *var1, char *var2, char *var3, char *var4, char *var5, char *var6, char *var7 ) {
line 554
;554:	return syscall( BOTLIB_AI_REPLY_CHAT, chatstate, message, mcontext, vcontext, var0, var1, var2, var3, var4, var5, var6, var7 );
CNSTI4 514
ARGI4
ADDRFP4 0
INDIRI4
...
;555:}
;556:
;557:int trap_BotChatLength(int chatstate) {
line 558
;558:	return syscall( BOTLIB_AI_CHAT_LENGTH, chatstate );
CNSTI4 515
ARGI4
ADDRFP4 0
INDIRI4
...
;559:}
;560:
;561:void trap_BotEnterChat(int chatstate, int client, int sendto) {
line 562
;562:	syscall( BOTLIB_AI_ENTER_CHAT, chatstate, client, sendto );
CNSTI4 516
ARGI4
ADDRFP4 0
INDIRI4
...
line 565
;564:
;565:void trap_BotGetChatMessage(int chatstate, char *buf, int size) {
line 566
;566:	syscall( BOTLIB_AI_GET_CHAT_MESSAGE, chatstate, buf, size);
CNSTI4 570
ARGI4
ADDRFP4 0
INDIRI4
...
line 569
;568:
;569:int trap_StringContains(char *str1, char *str2, int casesensitive) {
line 570
;570:	return syscall( BOTLIB_AI_STRING_CONTAINS, str1, str2, casesensitive );
CNSTI4 517
ARGI4
ADDRFP4 0
INDIRP4
...
;571:}
;572:
;573:int trap_BotFindMatch(char *str, void /* struct bot_match_s */ *match, unsigned long int context) {
line 574
;574:	return syscall( BOTLIB_AI_FIND_MATCH, str, match, context );
CNSTI4 518
ARGI4
ADDRFP4 0
INDIRP4
...
;575:}
;576:
;577:void trap_BotMatchVariable(void /* struct bot_match_s */ *match, int variable, char *buf, int size) {
line 578
;578:	syscall( BOTLIB_AI_MATCH_VARIABLE, match, variable, buf, size );
CNSTI4 519
ARGI4
ADDRFP4 0
INDIRP4
...
line 581
;580:
;581:void trap_UnifyWhiteSpaces(char *string) {
line 582
;582:	syscall( BOTLIB_AI_UNIFY_WHITE_SPACES, string );
CNSTI4 520
ARGI4
ADDRFP4 0
INDIRP4
...
line 585
;584:
;585:void trap_BotReplaceSynonyms(char *string, unsigned long int context) {
line 586
;586:	syscall( BOTLIB_AI_REPLACE_SYNONYMS, string, context );
CNSTI4 521
ARGI4
ADDRFP4 0
INDIRP4
...
line 589
;588:
;589:int trap_BotLoadChatFile(int chatstate, char *chatfile, char *chatname) {
line 590
;590:	return syscall( BOTLIB_AI_LOAD_CHAT_FILE, chatstate, chatfile, chatname );
CNSTI4 522
ARGI4
ADDRFP4 0
INDIRI4
...
;591:}
;592:
;593:void trap_BotSetChatGender(int chatstate, int gender) {
line 594
;594:	syscall( BOTLIB_AI_SET_CHAT_GENDER, chatstate, gender );
CNSTI4 523
ARGI4
ADDRFP4 0
INDIRI4
...
line 597
;596:
;597:void trap_BotSetChatName(int chatstate, char *name, int client) {
line 598
;598:	syscall( BOTLIB_AI_SET_CHAT_NAME, chatstate, name, client );
CNSTI4 524
ARGI4
ADDRFP4 0
INDIRI4
...
line 601
;600:
;601:void trap_BotResetGoalState(int goalstate) {
line 602
;602:	syscall( BOTLIB_AI_RESET_GOAL_STATE, goalstate );
CNSTI4 525
ARGI4
ADDRFP4 0
INDIRI4
...
line 605
;604:
;605:void trap_BotResetAvoidGoals(int goalstate) {
line 606
;606:	syscall( BOTLIB_AI_RESET_AVOID_GOALS, goalstate );
CNSTI4 526
ARGI4
ADDRFP4 0
INDIRI4
...
line 609
;608:
;609:void trap_BotRemoveFromAvoidGoals(int goalstate, int number) {
line 610
;610:	syscall( BOTLIB_AI_REMOVE_FROM_AVOID_GOALS, goalstate, number);
CNSTI4 571
ARGI4
ADDRFP4 0
INDIRI4
...
line 613
;612:
;613:void trap_BotPushGoal(int goalstate, void /* struct bot_goal_s */ *goal) {
line 614
;614:	syscall( BOTLIB_AI_PUSH_GOAL, goalstate, goal );
CNSTI4 527
ARGI4
ADDRFP4 0
INDIRI4
...
line 617
;616:
;617:void trap_BotPopGoal(int goalstate) {
line 618
;618:	syscall( BOTLIB_AI_POP_GOAL, goalstate );
CNSTI4 528
ARGI4
ADDRFP4 0
INDIRI4
...
line 621
;620:
;621:void trap_BotEmptyGoalStack(int goalstate) {
line 622
;622:	syscall( BOTLIB_AI_EMPTY_GOAL_STACK, goalstate );
CNSTI4 529
ARGI4
ADDRFP4 0
INDIRI4
...
line 625
;624:
;625:void trap_BotDumpAvoidGoals(int goalstate) {
line 626
;626:	syscall( BOTLIB_AI_DUMP_AVOID_GOALS, goalstate );
CNSTI4 530
ARGI4
ADDRFP4 0
INDIRI4
...
line 629
;628:
;629:void trap_BotDumpGoalStack(int goalstate) {
line 630
;630:	syscall( BOTLIB_AI_DUMP_GOAL_STACK, goalstate );
CNSTI4 531
ARGI4
ADDRFP4 0
INDIRI4
...
line 633
;632:
;633:void trap_BotGoalName(int number, char *name, int size) {
line 634
;634:	syscall( BOTLIB_AI_GOAL_NAME, number, name, size );
CNSTI4 532
ARGI4
ADDRFP4 0
INDIRI4
...
line 637
;636:
;637:int trap_BotGetTopGoal(int goalstate, void /* struct bot_goal_s */ *goal) {
line 638
;638:	return syscall( BOTLIB_AI_GET_TOP_GOAL, goalstate, goal );
CNSTI4 533
ARGI4
ADDRFP4 0
INDIRI4
...
;639:}
;640:
;641:int trap_BotGetSecondGoal(int goalstate, void /* struct bot_goal_s */ *goal) {
line 642
;642:	return syscall( BOTLIB_AI_GET_SECOND_GOAL, goalstate, goal );
CNSTI4 534
ARGI4
ADDRFP4 0
INDIRI4
...
;643:}
;644:
;645:int trap_BotChooseLTGItem(int goalstate, vec3_t origin, int *inventory, int travelflags) {
line 646
;646:	return syscall( BOTLIB_AI_CHOOSE_LTG_ITEM, goalstate, origin, inventory, travelflags );
CNSTI4 535
ARGI4
ADDRFP4 0
INDIRI4
...
;647:}
;648:
;649:int trap_BotChooseNBGItem(int goalstate, vec3_t origin, int *inventory, int travelflags, void /* struct bot_goal_s */ *ltg, float maxtime) {
line 650
;650:	return syscall( BOTLIB_AI_CHOOSE_NBG_ITEM, goalstate, origin, inventory, travelflags, ltg, PASSFLOAT(maxtime) );
ADDRFP4 20
INDIRF4
ARGF4
ADDRLP4 0
...
;651:}
;652:
;653:int trap_BotTouchingGoal(vec3_t origin, void /* struct bot_goal_s */ *goal) {
line 654
;654:	return syscall( BOTLIB_AI_TOUCHING_GOAL, origin, goal );
CNSTI4 537
ARGI4
ADDRFP4 0
INDIRP4
...
;655:}
;656:
;657:int trap_BotItemGoalInVisButNotVisible(int viewer, vec3_t eye, vec3_t viewangles, void /* struct bot_goal_s */ *goal) {
line 658
;658:	return syscall( BOTLIB_AI_ITEM_GOAL_IN_VIS_BUT_NOT_VISIBLE, viewer, eye, viewangles, goal );
CNSTI4 538
ARGI4
ADDRFP4 0
INDIRI4
...
;659:}
;660:
;661:int trap_BotGetLevelItemGoal(int index, char *classname, void /* struct bot_goal_s */ *goal) {
line 662
;662:	return syscall( BOTLIB_AI_GET_LEVEL_ITEM_GOAL, index, classname, goal );
CNSTI4 539
ARGI4
ADDRFP4 0
INDIRI4
...
;663:}
;664:
;665:int trap_BotGetNextCampSpotGoal(int num, void /* struct bot_goal_s */ *goal) {
line 666
;666:	return syscall( BOTLIB_AI_GET_NEXT_CAMP_SPOT_GOAL, num, goal );
CNSTI4 567
ARGI4
ADDRFP4 0
INDIRI4
...
;667:}
;668:
;669:int trap_BotGetMapLocationGoal(char *name, void /* struct bot_goal_s */ *goal) {
line 670
;670:	return syscall( BOTLIB_AI_GET_MAP_LOCATION_GOAL, name, goal );
CNSTI4 568
ARGI4
ADDRFP4 0
INDIRP4
...
;671:}
;672:
;673:float trap_BotAvoidGoalTime(int goalstate, int number) {
line 675
;674:	int temp;
;675:	temp = syscall( BOTLIB_AI_AVOID_GOAL_TIME, goalstate, number );
CNSTI4 540
ARGI4
ADDRFP4 0
INDIRI4
...
;677:}
;678:
;679:void trap_BotSetAvoidGoalTime(int goalstate, int number, float avoidtime) {
line 680
;680:	syscall( BOTLIB_AI_SET_AVOID_GOAL_TIME, goalstate, number, PASSFLOAT(avoidtime));
ADDRFP4 8
INDIRF4
ARGF4
ADDRLP4 0
...
line 683
;682:
;683:void trap_BotInitLevelItems(void) {
line 684
;684:	syscall( BOTLIB_AI_INIT_LEVEL_ITEMS );
CNSTI4 541
ARGI4
ADDRGP4 syscall
INDIRP4
...
line 687
;686:
;687:void trap_BotUpdateEntityItems(void) {
line 688
;688:	syscall( BOTLIB_AI_UPDATE_ENTITY_ITEMS );
CNSTI4 542
ARGI4
ADDRGP4 syscall
INDIRP4
...
line 691
;690:
;691:int trap_BotLoadItemWeights(int goalstate, char *filename) {
line 692
;692:	return syscall( BOTLIB_AI_LOAD_ITEM_WEIGHTS, goalstate, filename );
CNSTI4 543
ARGI4
ADDRFP4 0
INDIRI4
...
;693:}
;694:
;695:void trap_BotFreeItemWeights(int goalstate) {
line 696
;696:	syscall( BOTLIB_AI_FREE_ITEM_WEIGHTS, goalstate );
CNSTI4 544
ARGI4
ADDRFP4 0
INDIRI4
...
line 699
;698:
;699:void trap_BotInterbreedGoalFuzzyLogic(int parent1, int parent2, int child) {
line 700
;700:	syscall( BOTLIB_AI_INTERBREED_GOAL_FUZZY_LOGIC, parent1, parent2, child );
CNSTI4 565
ARGI4
ADDRFP4 0
INDIRI4
...
line 703
;702:
;703:void trap_BotSaveGoalFuzzyLogic(int goalstate, char *filename) {
line 704
;704:	syscall( BOTLIB_AI_SAVE_GOAL_FUZZY_LOGIC, goalstate, filename );
CNSTI4 545
ARGI4
ADDRFP4 0
INDIRI4
...
line 707
;706:
;707:void trap_BotMutateGoalFuzzyLogic(int goalstate, float range) {
line 708
;708:	syscall( BOTLIB_AI_MUTATE_GOAL_FUZZY_LOGIC, goalstate, range );
CNSTI4 566
ARGI4
ADDRFP4 0
INDIRI4
...
line 711
;710:
;711:int trap_BotAllocGoalState(int state) {
line 712
;712:	return syscall( BOTLIB_AI_ALLOC_GOAL_STATE, state );
CNSTI4 546
ARGI4
ADDRFP4 0
INDIRI4
...
;713:}
;714:
;715:void trap_BotFreeGoalState(int handle) {
line 716
;716:	syscall( BOTLIB_AI_FREE_GOAL_STATE, handle );
CNSTI4 547
ARGI4
ADDRFP4 0
INDIRI4
...
line 719
;718:
;719:void trap_BotResetMoveState(int movestate) {
line 720
;720:	syscall( BOTLIB_AI_RESET_MOVE_STATE, movestate );
CNSTI4 548
ARGI4
ADDRFP4 0
INDIRI4
...
line 723
;722:
;723:void trap_BotAddAvoidSpot(int movestate, vec3_t origin, float radius, int type) {
line 724
;724:	syscall( BOTLIB_AI_ADD_AVOID_SPOT, movestate, origin, PASSFLOAT(radius), type);
ADDRFP4 8
INDIRF4
ARGF4
ADDRLP4 0
...
line 727
;726:
;727:void trap_BotMoveToGoal(void /* struct bot_moveresult_s */ *result, int movestate, void /* struct bot_goal_s */ *goal, int travelflags) {
line 728
;728:	syscall( BOTLIB_AI_MOVE_TO_GOAL, result, movestate, goal, travelflags );
CNSTI4 549
ARGI4
ADDRFP4 0
INDIRP4
...
line 731
;730:
;731:int trap_BotMoveInDirection(int movestate, vec3_t dir, float speed, int type) {
line 732
;732:	return syscall( BOTLIB_AI_MOVE_IN_DIRECTION, movestate, dir, PASSFLOAT(speed), type );
ADDRFP4 8
INDIRF4
ARGF4
ADDRLP4 0
...
;733:}
;734:
;735:void trap_BotResetAvoidReach(int movestate) {
line 736
;736:	syscall( BOTLIB_AI_RESET_AVOID_REACH, movestate );
CNSTI4 551
ARGI4
ADDRFP4 0
INDIRI4
...
line 739
;738:
;739:void trap_BotResetLastAvoidReach(int movestate) {
line 740
;740:	syscall( BOTLIB_AI_RESET_LAST_AVOID_REACH,movestate  );
CNSTI4 552
ARGI4
ADDRFP4 0
INDIRI4
...
line 743
;742:
;743:int trap_BotReachabilityArea(vec3_t origin, int testground) {
line 744
;744:	return syscall( BOTLIB_AI_REACHABILITY_AREA, origin, testground );
CNSTI4 553
ARGI4
ADDRFP4 0
INDIRP4
...
;745:}
;746:
;747:int trap_BotMovementViewTarget(int movestate, void /* struct bot_goal_s */ *goal, int travelflags, float lookahead, vec3_t target) {
line 748
;748:	return syscall( BOTLIB_AI_MOVEMENT_VIEW_TARGET, movestate, goal, travelflags, PASSFLOAT(lookahead), target );
ADDRFP4 12
INDIRF4
ARGF4
ADDRLP4 0
...
;749:}
;750:
;751:int trap_BotPredictVisiblePosition(vec3_t origin, int areanum, void /* struct bot_goal_s */ *goal, int travelflags, vec3_t target) {
line 752
;752:	return syscall( BOTLIB_AI_PREDICT_VISIBLE_POSITION, origin, areanum, goal, travelflags, target );
CNSTI4 572
ARGI4
ADDRFP4 0
INDIRP4
...
;753:}
;754:
;755:int trap_BotAllocMoveState(void) {
line 756
;756:	return syscall( BOTLIB_AI_ALLOC_MOVE_STATE );
CNSTI4 555
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;757:}
;758:
;759:void trap_BotFreeMoveState(int handle) {
line 760
;760:	syscall( BOTLIB_AI_FREE_MOVE_STATE, handle );
CNSTI4 556
ARGI4
ADDRFP4 0
INDIRI4
...
line 763
;762:
;763:void trap_BotInitMoveState(int handle, void /* struct bot_initmove_s */ *initmove) {
line 764
;764:	syscall( BOTLIB_AI_INIT_MOVE_STATE, handle, initmove );
CNSTI4 557
ARGI4
ADDRFP4 0
INDIRI4
...
line 767
;766:
;767:int trap_BotChooseBestFightWeapon(int weaponstate, int *inventory) {
line 768
;768:	return syscall( BOTLIB_AI_CHOOSE_BEST_FIGHT_WEAPON, weaponstate, inventory );
CNSTI4 558
ARGI4
ADDRFP4 0
INDIRI4
...
;769:}
;770:
;771:void trap_BotGetWeaponInfo(int weaponstate, int weapon, void /* struct weaponinfo_s */ *weaponinfo) {
line 772
;772:	syscall( BOTLIB_AI_GET_WEAPON_INFO, weaponstate, weapon, weaponinfo );
CNSTI4 559
ARGI4
ADDRFP4 0
INDIRI4
...
line 775
;774:
;775:int trap_BotLoadWeaponWeights(int weaponstate, char *filename) {
line 776
;776:	return syscall( BOTLIB_AI_LOAD_WEAPON_WEIGHTS, weaponstate, filename );
CNSTI4 560
ARGI4
ADDRFP4 0
INDIRI4
...
;777:}
;778:
;779:int trap_BotAllocWeaponState(void) {
line 780
;780:	return syscall( BOTLIB_AI_ALLOC_WEAPON_STATE );
CNSTI4 561
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;781:}
;782:
;783:void trap_BotFreeWeaponState(int weaponstate) {
line 784
;784:	syscall( BOTLIB_AI_FREE_WEAPON_STATE, weaponstate );
CNSTI4 562
ARGI4
ADDRFP4 0
INDIRI4
...
line 787
;786:
;787:void trap_BotResetWeaponState(int weaponstate) {
line 788
;788:	syscall( BOTLIB_AI_RESET_WEAPON_STATE, weaponstate );
CNSTI4 563
ARGI4
ADDRFP4 0
INDIRI4
...
line 791
;790:
;791:int trap_GeneticParentsAndChildSelection(int numranks, float *ranks, int *parent1, int *parent2, int *child) {
line 792
;792:	return syscall( BOTLIB_AI_GENETIC_PARENTS_AND_CHILD_SELECTION, numranks, ranks, parent1, parent2, child );
CNSTI4 564
ARGI4
ADDRFP4 0
INDIRI4
...
;793:}
;794:
;795:int trap_PC_LoadSource( const char *filename ) {
line 796
;796:	return syscall( BOTLIB_PC_LOAD_SOURCE, filename );
CNSTI4 578
ARGI4
ADDRFP4 0
INDIRP4
...
;797:}
;798:
;799:int trap_PC_FreeSource( int handle ) {
line 800
;800:	return syscall( BOTLIB_PC_FREE_SOURCE, handle );
CNSTI4 579
ARGI4
ADDRFP4 0
INDIRI4
...
;801:}
;802:
;803:int trap_PC_ReadToken( int handle, pc_token_t *pc_token ) {
line 804
;804:	return syscall( BOTLIB_PC_READ_TOKEN, handle, pc_token );
CNSTI4 580
ARGI4
ADDRFP4 0
INDIRI4
...
;805:}
;806:
;807:int trap_PC_SourceFileAndLine( int handle, char *filename, int *line ) {
line 808
;808:	return syscall( BOTLIB_PC_SOURCE_FILE_AND_LINE, handle, filename, line );
CNSTI4 581
ARGI4
ADDRFP4 0
INDIRI4
...
;811:
;812:/*
;813:Ghoul2 Insert Start
;814:*/
;815:// CG Specific API calls
;816:void trap_G2_ListModelBones(void *ghlInfo, int frame)
;817:{
line 818
;818:	syscall( G_G2_LISTBONES, ghlInfo, frame);
CNSTI4 582
ARGI4
ADDRFP4 0
INDIRP4
...
line 822
;820:
;821:void trap_G2_ListModelSurfaces(void *ghlInfo)
;822:{
line 823
;823:	syscall( G_G2_LISTSURFACES, ghlInfo);
CNSTI4 583
ARGI4
ADDRFP4 0
INDIRP4
...
line 827
;825:
;826:qboolean trap_G2_HaveWeGhoul2Models(	void *ghoul2)
;827:{
line 828
;828:	return (qboolean)(syscall(G_G2_HAVEWEGHOULMODELS, ghoul2));
CNSTI4 584
ARGI4
ADDRFP4 0
INDIRP4
...
;829:}
;830:
;831:void trap_G2_SetGhoul2ModelIndexes(void *ghoul2, qhandle_t *modelList, qhandle_t *skinList)
;832:{
line 833
;833:	syscall( G_G2_SETMODELS, ghoul2, modelList, skinList);
CNSTI4 585
ARGI4
ADDRFP4 0
INDIRP4
...
line 838
;835:
;836:qboolean trap_G2API_GetBoltMatrix(void *ghoul2, const int modelIndex, const int boltIndex, mdxaBone_t *matrix,
;837:								const vec3_t angles, const vec3_t position, const int frameNum, qhandle_t *modelList, vec3_t scale)
;838:{
line 839
;839:	return (qboolean)(syscall(G_G2_GETBOLT, ghoul2, modelIndex, boltIndex, matrix, angles, position, frameNum, modelList, scale));
CNSTI4 586
ARGI4
ADDRFP4 0
INDIRP4
...
;840:}
;841:
;842:qboolean trap_G2API_GetBoltMatrix_NoReconstruct(void *ghoul2, const int modelIndex, const int boltIndex, mdxaBone_t *matrix,
;843:								const vec3_t angles, const vec3_t position, const int frameNum, qhandle_t *modelList, vec3_t scale)
;844:{ //Same as above but force it to not reconstruct the skeleton before getting the bolt position
line 845
;845:	return (qboolean)(syscall(G_G2_GETBOLT_NOREC, ghoul2, modelIndex, boltIndex, matrix, angles, position, frameNum, modelList, scale));
CNSTI4 587
ARGI4
ADDRFP4 0
INDIRP4
...
;846:}
;847:
;848:qboolean trap_G2API_GetBoltMatrix_NoRecNoRot(void *ghoul2, const int modelIndex, const int boltIndex, mdxaBone_t *matrix,
;849:								const vec3_t angles, const vec3_t position, const int frameNum, qhandle_t *modelList, vec3_t scale)
;850:{ //Same as above but force it to not reconstruct the skeleton before getting the bolt position
line 851
;851:	return (qboolean)(syscall(G_G2_GETBOLT_NOREC_NOROT, ghoul2, modelIndex, boltIndex, matrix, angles, position, frameNum, modelList, scale));
CNSTI4 588
ARGI4
ADDRFP4 0
INDIRP4
...
;852:}
;853:
;854:int trap_G2API_InitGhoul2Model(void **ghoul2Ptr, const char *fileName, int modelIndex, qhandle_t customSkin,
;855:						  qhandle_t customShader, int modelFlags, int lodBias)
;856:{
line 857
;857:	return syscall(G_G2_INITGHOUL2MODEL, ghoul2Ptr, fileName, modelIndex, customSkin, customShader, modelFlags, lodBias);
CNSTI4 589
ARGI4
ADDRFP4 0
INDIRP4
...
;858:}
;859:
;860:int trap_G2API_AddBolt(void *ghoul2, int modelIndex, const char *boneName)
;861:{
line 862
;862:	return syscall(G_G2_ADDBOLT, ghoul2, modelIndex, boneName);
CNSTI4 590
ARGI4
ADDRFP4 0
INDIRP4
...
;863:}
;864:
;865:void trap_G2API_SetBoltInfo(void *ghoul2, int modelIndex, int boltInfo)
;866:{
line 867
;867:	syscall(G_G2_SETBOLTINFO, ghoul2, modelIndex, boltInfo);
CNSTI4 591
ARGI4
ADDRFP4 0
INDIRP4
...
line 873
;869:
;870:qboolean trap_G2API_SetBoneAngles(void *ghoul2, int modelIndex, const char *boneName, const vec3_t angles, const int flags,
;871:								const int up, const int right, const int forward, qhandle_t *modelList,
;872:								int blendTime , int currentTime )
;873:{
line 874
;874:	return (syscall(G_G2_ANGLEOVERRIDE, ghoul2, modelIndex, boneName, angles, flags, up, right, forward, modelList, blendTime, currentTime));
CNSTI4 592
ARGI4
ADDRFP4 0
INDIRP4
...
;875:}
;876:
;877:qboolean trap_G2API_SetBoneAnim(void *ghoul2, const int modelIndex, const char *boneName, const int startFrame, const int endFrame,
;878:							  const int flags, const float animSpeed, const int currentTime, const float setFrame , const int blendTime )
;879:{
line 880
;880:	return syscall(G_G2_PLAYANIM, ghoul2, modelIndex, boneName, startFrame, endFrame, flags, PASSFLOAT(animSpeed), currentTime, PASSFLOAT(setFrame), blendTime);
ADDRFP4 24
INDIRF4
ARGF4
ADDRLP4 0
...
;881:}
;882:
;883:void trap_G2API_GetGLAName(void *ghoul2, int modelIndex, char *fillBuf)
;884:{
line 885
;885:	syscall(G_G2_GETGLANAME, ghoul2, modelIndex, fillBuf);
CNSTI4 594
ARGI4
ADDRFP4 0
INDIRP4
...
line 889
;887:
;888:int trap_G2API_CopyGhoul2Instance(void *g2From, void *g2To, int modelIndex)
;889:{
line 890
;890:	return syscall(G_G2_COPYGHOUL2INSTANCE, g2From, g2To, modelIndex);
CNSTI4 595
ARGI4
ADDRFP4 0
INDIRP4
...
;891:}
;892:
;893:void trap_G2API_CopySpecificGhoul2Model(void *g2From, int modelFrom, void *g2To, int modelTo)
;894:{
line 895
;895:	syscall(G_G2_COPYSPECIFICGHOUL2MODEL, g2From, modelFrom, g2To, modelTo);
CNSTI4 596
ARGI4
ADDRFP4 0
INDIRP4
...
line 899
;897:
;898:void trap_G2API_DuplicateGhoul2Instance(void *g2From, void **g2To)
;899:{
line 900
;900:	syscall(G_G2_DUPLICATEGHOUL2INSTANCE, g2From, g2To);
CNSTI4 597
ARGI4
ADDRFP4 0
INDIRP4
...
line 904
;902:
;903:qboolean trap_G2API_HasGhoul2ModelOnIndex(void *ghlInfo, int modelIndex)
;904:{
line 905
;905:	return syscall(G_G2_HASGHOUL2MODELONINDEX, ghlInfo, modelIndex);
CNSTI4 598
ARGI4
ADDRFP4 0
INDIRP4
...
;906:}
;907:
;908:qboolean trap_G2API_RemoveGhoul2Model(void *ghlInfo, int modelIndex)
;909:{
line 910
;910:	return syscall(G_G2_REMOVEGHOUL2MODEL, ghlInfo, modelIndex);
CNSTI4 599
ARGI4
ADDRFP4 0
INDIRP4
...
;911:}
;912:
;913:void trap_G2API_CleanGhoul2Models(void **ghoul2Ptr)
;914:{
line 915
;915:	syscall(G_G2_CLEANMODELS, ghoul2Ptr);
CNSTI4 600
ARGI4
ADDRFP4 0
INDIRP4
...
line 932
;917:
;918:void trap_G2API_CollisionDetect ( 
;919:	CollisionRecord_t *collRecMap, 
;920:	void* ghoul2, 
;921:	const vec3_t angles, 
;922:	const vec3_t position,
;923:	int frameNumber, 
;924:	int entNum, 
;925:	vec3_t rayStart, 
;926:	vec3_t rayEnd, 
...
;932:{
line 933
;933:	syscall ( G_G2_COLLISIONDETECT, collRecMap, ghoul2, angles, position, frameNumber, entNum, rayStart, rayEnd, scale, traceFlags, useLod, PASSFLOAT(fRadius) );
ADDRFP4 44
INDIRF4
ARGF4
ADDRLP4 0
