...
//cm BEGIN
vmCvar_t	cm_console_motd;
vmCvar_t	cm_motd;
vmCvar_t	cm_motd_time;
vmCvar_t	cm_dualblade;
vmCvar_t	cm_savedualblade;
vmCvar_t	cm_multiduels;
vmCvar_t	cm_duelbeginsaberoff;
vmCvar_t	mod_pushall;
vmCvar_t	cm_duelstatus;
vmCvar_t	cm_samenames;
vmCvar_t	cm_duelradius;
vmCvar_t	cm_duelhealth;
vmCvar_t	cm_duelshield;
vmCvar_t	cm_blacknames;
vmCvar_t	cm_knockmedown;
vmCvar_t	cm_badwords;
vmCvar_t	cm_clanTag;
vmCvar_t	cm_report;
vmCvar_t	cm_adminLevel1;
vmCvar_t	cm_adminLevel2;
vmCvar_t	cm_adminLevel3;
vmCvar_t	cm_adminControl1;
vmCvar_t	cm_adminControl2;
vmCvar_t	cm_adminControl3;
vmCvar_t	cm_emoteControl;
vmCvar_t	cm_voteControl;
vmCvar_t	cm_adminPassword1;
vmCvar_t	cm_adminPassword2;
vmCvar_t	cm_adminPassword3;
vmCvar_t	cm_AdminLogin1_saying;
vmCvar_t	cm_AdminLogin2_saying;
vmCvar_t	cm_AdminLogin3_saying;
vmCvar_t	cm_AdminLogout1_saying;
vmCvar_t	cm_AdminLogout2_saying;
vmCvar_t	cm_AdminLogout3_saying;
vmCvar_t	cm_clanPassword;
vmCvar_t	sv_maxConnections;
vmCvar_t	cm_autoprotecttime;
vmCvar_t	cm_empower_on_saying;
vmCvar_t	cm_empower_off_saying;
vmCvar_t	cm_terminator_on_saying;
vmCvar_t	cm_terminator_off_saying;
vmCvar_t	cm_protect_on_saying;
vmCvar_t	cm_protect_off_saying;
vmCvar_t	cm_silence_on_saying;
vmCvar_t	cm_silence_off_saying;
vmCvar_t	cm_slap_saying;
vmCvar_t	cm_punish_on_saying;
vmCvar_t	cm_punish_off_saying;
vmCvar_t	cm_sleep_on_saying;
vmCvar_t	cm_sleep_off_saying;
vmCvar_t	cm_slay_saying;
vmCvar_t	cm_teleport_saying;
...
static cvarTable_t		gameCvarTable[] = {
	...
	{ &g_austrian, "g_austrian", "0", CVAR_ARCHIVE, 0, qfalse },
		...
		//cm BEGIN
	{ &cm_console_motd, "cm_console_motd", "Welcome.", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_motd, "cm_motd", "Welcome to a Clan Mod beta server!\n\nwww.ClanMod.org", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_motd_time,  "cm_motd_time",  "5", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_dualblade,  "cm_dualblade",  "0", CVAR_ARCHIVE, 0, qtrue },
	{ &cm_savedualblade,  "cm_savedualblade",  "0", CVAR_ARCHIVE, 0, qtrue },
	{ &cm_multiduels, "cm_multiduels", "0", CVAR_ARCHIVE, 0, qtrue },
	{ &cm_duelbeginsaberoff, "cm_duelbeginsaberoff", "0", CVAR_ARCHIVE, 0, qtrue },
	{ &mod_pushall,    "cm_pushall",     "0",   CVAR_ARCHIVE, 0, qtrue },
	{ &cm_samenames,   "cm_samenames",   "0",   CVAR_ARCHIVE, 0, qtrue },
	{ &cm_duelradius,  "cm_duelradius",  "0",   CVAR_ARCHIVE, 0, qtrue },
	{ &cm_duelstatus,  "cm_duelstatus",  "0",   CVAR_ARCHIVE, 0, qtrue },
	{ &cm_duelhealth,  "cm_duelhealth",  "100", CVAR_ARCHIVE, 0, qtrue },
	{ &cm_duelshield,  "cm_duelshield",  "100", CVAR_ARCHIVE, 0, qtrue },
	{ &cm_blacknames,  "cm_blacknames",  "0",   CVAR_ARCHIVE, 0, qtrue },
	{ &cm_knockmedown, "cm_knockmedown", "0",   CVAR_ARCHIVE, 0, qtrue },
	{ &cm_badwords,    "cm_badwords",    "",    CVAR_ARCHIVE, 0, qfalse },
	{ &sv_maxConnections,  "sv_maxConnections",  "0", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_autoprotecttime, "cm_autoprotecttime", "0", CVAR_ARCHIVE, 0, qtrue },
	{ &cm_clanTag, "cm_clanTag", "0", CVAR_ARCHIVE, 0, qtrue },
	{ &cm_report,  "cm_report",  "0", CVAR_ARCHIVE, 0, qtrue },
	{ &cm_adminLevel1, "cm_adminLevel1", "^5Advisor", CVAR_ARCHIVE, 0, qtrue },
	{ &cm_adminLevel2, "cm_adminLevel2", "^4Knight", CVAR_ARCHIVE, 0, qtrue },
	{ &cm_adminLevel3, "cm_adminLevel3", "^3Council", CVAR_ARCHIVE, 0, qtrue },
	{ &cm_clanPassword, "cm_clanPassword", "", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_adminPassword1, "cm_adminPassword1", "", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_adminPassword2, "cm_adminPassword2", "", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_adminPassword3, "cm_adminPassword3", "", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_adminControl1,  "cm_adminControl1",  "", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_adminControl2,  "cm_adminControl2",  "", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_adminControl3,  "cm_adminControl3",  "", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_emoteControl,   "cm_emoteControl",   "", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_voteControl,    "cm_voteControl",    "", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_AdminLogin1_saying,  "cm_AdminLogin1_saying",  "is logged in as an ^5Advisor!", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_AdminLogin2_saying,  "cm_AdminLogin2_saying",  "is logged in as a ^4Knight!",   CVAR_ARCHIVE, 0, qfalse },
	{ &cm_AdminLogin3_saying,  "cm_AdminLogin3_saying",  "is logged in as ^3Council!",    CVAR_ARCHIVE, 0, qfalse },
	{ &cm_AdminLogout1_saying, "cm_AdminLogout1_saying", "has logged out of ^5Advisor",   CVAR_ARCHIVE, 0, qfalse },
	{ &cm_AdminLogout2_saying, "cm_AdminLogout2_saying", "has logged out of ^4Knight",    CVAR_ARCHIVE, 0, qfalse },
	{ &cm_AdminLogout3_saying, "cm_AdminLogout3_saying", "has logged out of ^3Council",   CVAR_ARCHIVE, 0, qfalse },
	{ &cm_empower_on_saying,   "cm_empower_on_saying", "has become ^5EMPOWERED!", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_empower_off_saying,  "cm_empower_off_saying", "has lost ^5EMPOWERMENT", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_terminator_on_saying,  "cm_terminator_on_saying", "has become the ^1TERMINATOR!", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_terminator_off_saying, "cm_terminator_off_saying", "has lost ^1TERMINATOR", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_protect_on_saying,  "cm_protect_on_saying", "has become ^2PROTECTED!", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_protect_off_saying, "cm_protect_off_saying", "has lost ^2PROTECTION", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_slap_saying, "cm_slap_saying", "has been ^4SLAPPED!", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_silence_on_saying, "cm_silence_on_saying", "has been ^3SILENCED!", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_silence_off_saying, "cm_silence_off_saying", "may now ^3SPEAK", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_punish_on_saying, "cm_punish_on_saying", "is being ^0PUNISHED!", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_punish_off_saying, "cm_punish_off_saying", "is no longer ^0PUNISHED", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_sleep_on_saying, "cm_sleep_on_saying", "is going to ^5SLEEP!", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_sleep_off_saying, "cm_sleep_off_saying", "is ^5AWAKE", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_slay_saying, "cm_slay_saying", "has been ^1SLAIN!", CVAR_ARCHIVE, 0, qfalse },
	{ &cm_teleport_saying, "cm_teleport_saying", "has been ^6TELEPORTED!", CVAR_ARCHIVE, 0, qfalse },
	...
	{ &cm_uniquePipeName, "cm_uniquePipeName", "jko", CVAR_ARCHIVE, 0, qtrue },
	//cm END
};
// bk001129 - made static to avoid aliasing
